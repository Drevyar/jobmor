    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.background }]} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Pressable accessibilityRole="button" accessibilityLabel="Switch language" onPress={toggleLanguage} style={({ pressed }) => [styles.languageButton, { backgroundColor: pressed ? colors.primarySoft : colors.surface, borderColor: colors.border }]}>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1 }, content: { padding: 20, paddingBottom: 124, gap: 24, width: '100%', maxWidth: 760, alignSelf: 'center' },
  ...
  languageButton: { minWidth: 60, minHeight: 44, paddingHorizontal: 10, borderRadius: 12, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5 }, languageText: { fontSize: 12, fontWeight: '800' },
